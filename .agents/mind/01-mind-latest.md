...
- QC-ADP-11 binds provider URLs to exact official Groq/Gemini endpoints; this is a technical destination allowlist, not processing approval. PD-31 remains PARTIAL; no external provider call or live eval was made. Current route acceptance is 5/10 (50%), with security E2E, dependency audit, owner policy, and approved live eval blocked; details in `audit/2026-09-24/QC-ADP-11-handoff.md`.
