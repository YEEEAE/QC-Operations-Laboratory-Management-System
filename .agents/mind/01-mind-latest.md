...
- Exact current HEAD: `8e7162ded4861d24c5336f5d9e001e33a72eaaea` on `main` (verified 2026-09-18). Working tree includes local QC-CLOSURE-014 changes plus earlier local evidence/mind updates; no commit, push, or deployment. Migration source head is now `0029_performance_query_indexes`; it is not applied to Render and was not runtime-applied during this task.
