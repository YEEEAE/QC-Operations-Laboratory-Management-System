---
name: "source-command-design-research-interview"
description: "Prepare an interview script or summarize an interview transcript into structured insights."
---

# source-command-design-research-interview

Use this skill when the user asks to run the migrated source command `design-research--interview`.
