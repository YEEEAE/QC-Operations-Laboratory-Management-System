---
name: "source-command-prototyping-testing-test-plan"
...
# source-command-prototyping-testing-test-plan

Use this skill when the user asks to run the migrated source command `prototyping-testing--test-plan`.
