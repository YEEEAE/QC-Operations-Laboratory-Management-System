---
name: "source-command-interaction-design-design-interaction"
description: "Design a complete interaction flow for a feature or component."
---

# source-command-interaction-design-design-interaction

Use this skill when the user asks to run the migrated source command `interaction-design--design-interaction`.
