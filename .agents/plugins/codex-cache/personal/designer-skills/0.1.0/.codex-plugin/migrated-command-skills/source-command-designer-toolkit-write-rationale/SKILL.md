---
name: "source-command-designer-toolkit-write-rationale"
description: "Write design rationale for a set of decisions, linking each to user needs, business goals, and principles."
---

# source-command-designer-toolkit-write-rationale

Use this skill when the user asks to run the migrated source command `designer-toolkit--write-rationale`.
