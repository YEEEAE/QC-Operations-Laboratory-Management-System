---
name: "source-command-design-ops-plan-sprint"
description: "Run a design sprint end to end — challenge framing, schedule, exercises, and prototype test plan."
---

# source-command-design-ops-plan-sprint

Use this skill when the user asks to run the migrated source command `design-ops--plan-sprint`.
