---
name: "source-command-prototyping-testing-prototype-plan"
description: "Create a prototyping and testing plan for a design initiative."
---

# source-command-prototyping-testing-prototype-plan

Use this skill when the user asks to run the migrated source command `prototyping-testing--prototype-plan`.
