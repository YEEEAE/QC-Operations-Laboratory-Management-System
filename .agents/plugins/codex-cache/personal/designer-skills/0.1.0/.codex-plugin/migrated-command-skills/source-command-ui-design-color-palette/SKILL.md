---
name: "source-command-ui-design-color-palette"
...
# source-command-ui-design-color-palette

Use this skill when the user asks to run the migrated source command `ui-design--color-palette`.
