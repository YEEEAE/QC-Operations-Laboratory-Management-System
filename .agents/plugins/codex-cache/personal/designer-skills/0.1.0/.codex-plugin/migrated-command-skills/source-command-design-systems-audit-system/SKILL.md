---
name: "source-command-design-systems-audit-system"
description: "Run a comprehensive audit of an existing design system for consistency, completeness, and accessibility."
---

# source-command-design-systems-audit-system

Use this skill when the user asks to run the migrated source command `design-systems--audit-system`.
