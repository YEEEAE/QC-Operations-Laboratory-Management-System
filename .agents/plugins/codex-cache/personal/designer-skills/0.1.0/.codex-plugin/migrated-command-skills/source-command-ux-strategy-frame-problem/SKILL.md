---
name: "source-command-ux-strategy-frame-problem"
description: "Structure an ambiguous design challenge into a clear problem definition with constraints and criteria."
---

# source-command-ux-strategy-frame-problem

Use this skill when the user asks to run the migrated source command `ux-strategy--frame-problem`.
