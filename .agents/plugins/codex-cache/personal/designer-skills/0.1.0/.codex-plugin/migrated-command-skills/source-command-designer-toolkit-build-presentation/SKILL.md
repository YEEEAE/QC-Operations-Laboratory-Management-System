---
name: "source-command-designer-toolkit-build-presentation"
description: "Build a design presentation end to end — audience framing, narrative structure, and supporting rationale."
---

# source-command-designer-toolkit-build-presentation

Use this skill when the user asks to run the migrated source command `designer-toolkit--build-presentation`.
