---
name: "source-command-visual-critique-critique-ux"
...
# source-command-visual-critique-critique-ux

Use this skill when the user asks to run the migrated source command `visual-critique--critique-ux`.
