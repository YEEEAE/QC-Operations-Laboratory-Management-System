---
name: "source-command-visual-critique-critique-screen"
description: "Run all seven visual critiques on a screen and output a prioritised fix list."
---

# source-command-visual-critique-critique-screen

Use this skill when the user asks to run the migrated source command `visual-critique--critique-screen`.
