---
name: "source-command-ux-strategy-strategize"
description: "Develop a complete UX strategy for a product or feature area."
---

# source-command-ux-strategy-strategize

Use this skill when the user asks to run the migrated source command `ux-strategy--strategize`.
