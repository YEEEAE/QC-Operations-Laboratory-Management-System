---
name: "source-command-ui-design-design-screen"
description: "Design a complete screen layout from a description or requirements."
---

# source-command-ui-design-design-screen

Use this skill when the user asks to run the migrated source command `ui-design--design-screen`.
