---
name: "source-command-interaction-design-map-states"
description: "Model a component's states and transitions end to end — states, events, guards, and edge cases."
---

# source-command-interaction-design-map-states

Use this skill when the user asks to run the migrated source command `interaction-design--map-states`.
