...
test("JavaScript MCP server rejects malformed widget resource aliases", async () => {
  const [serverMajor] = server.SERVER_VERSION.split(".");
  const futurePrerelease = `${BigInt(serverMajor) + 1n}.0.0-alpha.1`;

  for (const uri of [
    "ui://widget/datascience-chart-999.0.0.html",
    "ui://widget/datascience-chart.html?v=999.0.0",
    `ui://widget/datascience-chart-${futurePrerelease}.html`,
