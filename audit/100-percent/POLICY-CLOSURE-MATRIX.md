...
| PD-31 | `src/modules/ai-advisory/infrastructure/disabled-ai-provider.ts`; advisory response; exact Groq/Gemini endpoint allowlist | Current HEAD `6b999b71c54e7e9c29399f8bae6a25b83ee39385`: AI/advisory `90/90` and synthetic v4.0.0 (33 cases) PASS; authenticated least-privilege denial E2E PASS on disposable PG18.6; dependency audit BLOCKED (registry DNS) | Advisory boundary verified; external provider remains disabled; exact technical endpoint allowlist is not a business processing approval | Provider contract, approved location/retention/deletion/classes/consent, limited live evaluation and reviewer UAT only after owner approval |
