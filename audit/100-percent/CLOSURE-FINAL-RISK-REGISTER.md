...
| R-007 | Scientific / policy controlled decisions | OPEN (narrowed) | Canonical matrix `POLICY-CLOSURE-MATRIX.md` closes only explicit P-05/P-06/P-07 authority decisions; PD-01–PD-37 QMS/provider/data-instance items remain OPEN/PARTIAL/BLOCKED. Fail-closed proof remains required; no scientific value or provider rule was invented. |
