...
- **التوصية والتصميم:** راجع المهمة الأساسية واللغة والاسترداد وإتاحة لوحة المفاتيح، مع عدم توسيع السلطة.
- **بطاقة الدليل (تحديث 2026-09-24):** على HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2` وmigration `0041_document_review_queue_indexes`: `astro check` PASS (984 files, 0 errors/0 warnings/89 hints), build/release identity PASS، focused AI/advisory tests 90/90 PASS، وتقييم synthetic v4.0.0 (33 حالة، fake provider) PASS؛ SBOM حديث 822 حزمة وUNKNOWN=0. `RT-AI-001` acceptance remains 5/10 (50%): 5 PASS, 1 NOT VERIFIED (browser/AT readability), 4 BLOCKED (authenticated security E2E, dependency advisory audit, owner policy approval, approved live-provider evaluation). E2E توقف قبل Playwright لغياب container runtime؛ advisory audit توقف عند DNS `ENOTFOUND`. لا provider call. **تقييم الجودة:** PARTIAL / NO-GO؛ **handoff:** `audit/2026-09-24/QC-ADP-11-handoff.md`؛ سجل محاولة E2E: `.ci-results/qc-adp-11-security-e2e-current.json`؛ العوائق المرتبطة: QC-PAGE-F-009, QC-PAGE-F-010, QC-PAGE-F-013, QC-PAGE-F-016, QC-PAGE-F-019, QC-PAGE-F-029
...
| `RT-AI-001` | `/ai-advisory` | حدود الاستشارة، provenance، consent، سياسة المعالجة  | على HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2`: AI/advisory 90/90 PASS، SBOM 822 حزمة وUNKNOWN=0، build/release PASS؛ acceptance 5/10 (50%). Browser/AT readability NOT VERIFIED؛ authenticated security E2E، dependency audit، owner policy، وapproved live eval BLOCKED. | أبق الإرسال الخارجي معطلًا حتى اعتماد المزود والمكان والاحتفاظ/الحذف وفئات البيانات وconsent؛ أظهر حدود المخرجات الاستشارية. | أرفق نجاحًا ورفضًا وحدود الدور من المرشح نفسه؛ لا READY حتى إغلاق المحجوبات وP0/P1. الأدلة: `audit/2026-09-24/QC-ADP-11-handoff.md`, `.ci-results/qc-adp-11-security-e2e-current.json`. | QC-ADP-08, QC-ADP-09, QC-ADP-12, QC-ADP-15, QC-ADP-11, QC-ADP-26 | PARTIAL / NO-GO |
