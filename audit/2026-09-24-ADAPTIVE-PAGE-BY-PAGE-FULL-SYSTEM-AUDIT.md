...
| 80 | `RT-AI-001` | `/ai-advisory` | Shared | Utility | `src/pages/ai-advisory.astro` | permission-bound/required | NOT VERIFIED | فعل/دور/حالة أو قياس ناقص | LIVE+SOURCE | QC-PAGE-F-009, QC-PAGE-F-010, QC-PAGE-F-013, QC-PAGE-F-016, QC-PAGE-F-019, QC-PAGE-F-029 |
...
- **التوصية والتصميم:** راجع المهمة الأساسية واللغة والاسترداد وإتاحة لوحة المفاتيح، مع عدم توسيع السلطة.
- **بطاقة الدليل:** source=PASS؛ live=OBSERVED؛ populated/role/PG/AT/performance/UAT=NOT VERIFIED. **تقييم الجودة:** NOT VERIFIED؛ **العوائق/الفحوص المطلوبة:** QC-PAGE-F-009, QC-PAGE-F-010, QC-PAGE-F-013, QC-PAGE-F-016, QC-PAGE-F-019., QC-PAGE-F-029
...
| `RT-DASH-001` | `/dashboard` | مصدر المؤشر، النطاق، الفترة، رابط التفاصيل | العدادات الحية صفر، وبعض مصادر الطوابير NOT_SUPPLIED؛ صحة العدد على بيانات ممثلة غير مثبتة. | اربط كل KPI بقراءة محددة ونطاق وفترة ورابط حفر مطابق، وافصل غير المورّد عن الصفر. | تطابق كل عدد مع صفوف السجل للممثلين المختلفين؛ لا يظهر صفر عند تعطل المصدر. | QC-ADP-08, QC-ADP-09, QC-ADP-12, QC-ADP-15, QC-ADP-07, QC-ADP-13 | NOT VERIFIED / NO-GO |
| `RT-WORK-001` | `/work` | مصدر المؤشر، النطاق، الفترة، رابط التفاصيل | لم يُثبت على بيانات ممثلة أن `/work` يعرض طابور العمل بالنطاق الصحيح ويفصل الصفر الحقيقي عن غياب المصدر. | حدد مصدر طابور العمل وعقد القراءة/الكتابة في الخادم؛ اربط الأرقام بالمصدر والنطاق والفترة ورابط السجل نفسه. | باستخدام بيانات ممثلة لـطابور العمل: الأعداد تطابق السجل تحت نطاقين، والتعطل لا يُعرض صفرًا. | QC-ADP-08, QC-ADP-09, QC-ADP-12, QC-ADP-15, QC-ADP-07, QC-ADP-13 | NOT VERIFIED / NO-GO |
...
| `RT-AI-001` | `/ai-advisory` | حدود الاستشارة، provenance، consent، سياسة المعالجة  | مزود AI الخارجي مغلق لغياب policy artifact معتمد، والتقييمات المتاحة synthetic. | أبق الإرسال الخارجي معطلًا حتى اعتماد المزود والمكان والاحتفاظ وفئات البيانات وموافقة الطلب؛ أظهر حدود المخرجات الاستشارية. | رفض أي إرسال بلا policy/consent، وإظهار المصدر والمراجعة البشرية وعدم تحويل المقترح إلى قرار QC. | QC-ADP-08, QC-ADP-09, QC-ADP-12, QC-ADP-15, QC-ADP-11, QC-ADP-26 | NOT VERIFIED / NO-GO |
