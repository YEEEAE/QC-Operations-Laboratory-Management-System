...
تحديث تخطيطي (2026-09-20؛ دون دليل جديد على المنتج): أصبحت الخطة التفاعلية تضم 67 مرحلة تنفيذ ضمن 42 عائلة مهام؛ قُسمت 21 عائلة واسعة إلى A/B أو A/B/C مع إبقاء المعرّف الأصلي للمرحلة A. لكل مرحلة نطاق وقواعد تنفيذ واستئناف وتسليم محدد. حُفظت بنود العمل الأصلية الـ188 كاملة. المهام الجديدة 019–042 حالتها PLANNED / NOT RUN وتأتي بعد البرومبت 018، وتغطي المجالات الهندسية والتصميمية المطلوبة وعددها 100 بروابط صريحة. معرّفات مجالات التدقيق الـ80 ومقام احتساب الدرجات لم تتغير. تبقى عائلة التدقيق النهائي012 أخيرًا بالترتيب 012 → 012-B → 012-C، ويزامن التقريرين والخطة بعد التنفيذ. تنفيذ القبول البشري مستبعد من البرومبتات بطلب المستخدم؛ المهمة 004 لتوثيق اعتماد الدليل البشري المتبقي فقط. هذا لا يلغي أدلة الإفراج الإلزامية ولا يغيّر النسب أو قرار NO-GO.
