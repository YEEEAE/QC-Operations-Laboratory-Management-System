...
test.describe('Quarantine protected workspaces', () => {
  test('redirects unauthenticated users and does not expose a public inspection creator', async ({
    page,
  }) => {
  ...
  test('keeps the controlled state vocabulary visible in the receiving workspace', async ({
    page,
  }) => {
