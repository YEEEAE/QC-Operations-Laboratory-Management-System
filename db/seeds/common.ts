...
> = {
  EMPLOYEE: [
    ...
    'PERM-CAPA-EDIT',
    'PERM-ADM-TEMPLATES',
    // Owner decision OD-2026-09-23-RBAC-01: QC data-entry users may create
    // reject reports but cannot confirm, finalize, or void them.
    'PERM-RREJ-VIEW',
    'PERM-RREJ-CREATE',
    'PERM-RREJ-EDIT',
  ],
  SUPERVISOR: [
    ...
    'PERM-ADM-TEMPLATES',
    'PERM-ESIG-SIGN',
    // Owner decision OD-2026-09-23-RBAC-01: Supervisor is first-stage only;
    // MANAGER/QCM holds final PERM-APR-APPROVE and signature authority.
    'PERM-QUAR-RELEASE',
