...
| **التصميم المعماري** (البنية، الطبقات، الأخطاء، المراقبة) | `ARCHITECTURE-SPECIFICATION.md`, `DATABASE-ARCHITECTURE.md`, `DEPLOYMENT-ARCHITECTURE.md`, `ERROR-ARCHITECTURE.md`, `OBSERVABILITY-ARCHITECTURE.md`, `SECURITY-ARCHITECTURE.md` |
