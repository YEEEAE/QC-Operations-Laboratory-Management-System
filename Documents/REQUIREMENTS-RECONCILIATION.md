...
| Requirement ID | RC ID | Requirement (legacy IDs) | Source | Business objective | Applicability | Capability | Owning task | Technical evidence reference |
|---|---|---|---|---|---|---|---|---|
| REQ-AIGV-001 | RC-06-001 | AI is advisory-only; cannot approve/reject/release/sign or set official PASS/FAIL (REQ-AI-003/004/005; RISK-030) | BR-AI-003..008 | AI never acquires controlled authority | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2`: focused AI/advisory 90/90 PASS; deterministic synthetic only; authenticated role E2E BLOCKED before Playwright |
| REQ-AIGV-002 | RC-06-002 | AI receives only authorized context; detected PII/secret-like input blocked before provider access (REQ-AI-006) | BR-AI-009; SECURITY-ARCHITECTURE | No data leakage to providers | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2`: focused AI/advisory 90/90 PASS; no provider call; live behavior NOT VERIFIED |
| REQ-AIGV-003 | RC-06-003 | Structured AI output schema-validated; output visibly advisory; authority-claiming text rejected (REQ-AI-007/008) | BR-AI-010/011 | AI output cannot masquerade as decision | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Focused AI/advisory 90/90 PASS on current HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2`; browser/AT readability NOT VERIFIED |
...
| REQ-AIGV-005 | RC-06-005 | Fail-safe refusal for high-risk unsupported-source requests; source identity/citations preserved when supplied | AI-PROVIDERS governance dataset `qc-ai-governance-v2` / 4.0.0 | Unsupported advice refused, not guessed | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `dc47645cc7072185cfd2c016668e6b611895f2e2`: 33 synthetic cases; all category disposition error rates 0%; no live model evaluated |
