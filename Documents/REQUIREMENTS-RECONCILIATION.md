...
| REQ-AUDF-004 | RC-04-004 | Report/export scope equals UI scope; spreadsheet formula injection prevented (REQ-RPT-*, REQ-SEC-009, RISK-022/023) | BR-AUTH-003; export rules | Exports disclose exactly what the user may see | Reporting / export | MANDATORY | QC-100-FINAL-011 | export scope tests; `audit/2026-09-19/QC-100-FINAL-011-*.md`; QC-ADP-10 candidate parity `audit/2026-09-24/QC-ADP-10-report-parity-handoff.md` (live/PERSISTED snapshot still blocked) |
...
| Requirement ID | RC ID | Requirement (legacy IDs) | Source | Business objective | Applicability | Capability | Owning task | Technical evidence reference |
|---|---|---|---|---|---|---|---|---|
| REQ-AIGV-001 | RC-06-001 | AI is advisory-only; cannot approve/reject/release/sign or set official PASS/FAIL (REQ-AI-003/004/005; RISK-030) | BR-AI-003..008 | AI never acquires controlled authority | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `6b999b71c54e7e9c29399f8bae6a25b83ee39385`: focused AI/advisory 90/90 PASS; deterministic synthetic only; authenticated least-privilege route denial E2E PASS; no release/QC decision path |
| REQ-AIGV-002 | RC-06-002 | AI receives only authorized context; detected PII/secret-like input blocked before provider access (REQ-AI-006) | BR-AI-009; SECURITY-ARCHITECTURE | No data leakage to providers | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `6b999b71c54e7e9c29399f8bae6a25b83ee39385`: focused AI/advisory 90/90 PASS; least-privilege direct action denied with sanitized 403; no provider call; live-provider behavior NOT VERIFIED |
| REQ-AIGV-003 | RC-06-003 | Structured AI output schema-validated; output visibly advisory; authority-claiming text rejected (REQ-AI-007/008) | BR-AI-010/011 | AI output cannot masquerade as decision | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Focused AI/advisory 90/90 PASS on current HEAD `6b999b71c54e7e9c29399f8bae6a25b83ee39385`; browser/AT readability NOT VERIFIED |
...
| REQ-AIGV-005 | RC-06-005 | Fail-safe refusal for high-risk unsupported-source requests; source identity/citations preserved when supplied | AI-PROVIDERS governance dataset `qc-ai-governance-v2` / 4.0.0 | Unsupported advice refused, not guessed | AI surfaces | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Current HEAD `6b999b71c54e7e9c29399f8bae6a25b83ee39385`: 33 synthetic cases; all category disposition error rates 0%; no live model evaluated |
| REQ-AIGV-006 | RC-06-006 | Provider configuration server-only; sanitized provider metadata; Groq primary / Gemini fallback / DisabledAiProvider final fallback | AI-PROVIDERS | No client-side provider secrets | AI configuration | MANDATORY | QC-100-FINAL-009, QC-ADP-11 | Focused AI/advisory 90/90 PASS on current HEAD; exact official endpoint allowlist; Render provider config NOT VERIFIED |
| REQ-AIGV-007 | RC-06-007 | External data-processing approval is an explicit external dependency before live provider use | AI-PROVIDERS | Legal/organizational consent precedes data flow | AI surfaces | MANDATORY | QC-100-FINAL-013, QC-ADP-11 | BLOCKED — no approved provider/location/retention/deletion/data-class/consent artifact; external processing remains disabled |
...
| REQ-READY-003 | RC-07-003 | Production release evidence server-derived via release_gate_evidence / release_risk_evidence; provider evidence requires signed signer/scope/digest, and approval additionally requires the approved 19-gate register reconciled to exact candidate; browser submits intent only (P-07) | REQUIREMENTS-TRACEABILITY P-07; PRODUCTION-READINESS-CHECKLIST | Release approval cannot be forged client-side or inferred from a partial gate model | Release governance | MANDATORY | QC-ADP-03 | PARTIAL — signed provider intake implemented locally; approved 19-gate reconciliation unavailable, so approval fails closed; `audit/2026-09-24/QC-ADP-03-release-evidence-handoff.md` |
...
| REQ-READY-007 | RC-07-007 | Exact-head CI evidence for the release candidate | TESTING-STRATEGY; CI gate §58 | CI proves the shipped thing | CI/CD | MANDATORY | QC-100-FINAL-002 / QC-ADP-03 | BLOCKED — GitHub status set empty on source HEAD `7e0a3535f80b956bcfe0143201ddfee2e4277e4c`; edited worktree has no exact-SHA run |
...
| REQ-READY-009 | RC-07-009 | Production migration gate: no production migration without explicit scoped authorization; applied-head parity proven | RENDER-MIGRATION-RUNBOOK | No silent schema drift in production | Production database | MANDATORY | QC-100-FINAL-001 / QC-ADP-03 | BLOCKED — source head `0040_signed_release_gate_evidence`; migration 0040 unapplied; historical Render read on 2026-09-22 reported 0018, current parity NOT VERIFIED |
