...
const policies: readonly AuthorizationPolicy[] = [
  ...
  {
    permission: 'PERM-LAB-ENTER-SAMPLE',
    action: 'SAVE',
    entityType: 'LAB_TEST',
    states: ['DRAFT'],
  },
  {
    permission: 'PERM-LAB-ENTER-MEASUREMENT',
    action: 'SAVE',
    entityType: 'LAB_TEST',
    states: ['DRAFT'],
  },
  ...
  ...(['FINDING', 'NCR', 'RCA', 'CAPA'].flatMap((entityType) => [
    {
      permission: `PERM-${entityType === 'FINDING' ? 'FIND' : entityType}-VIEW`,
      action: 'VIEW',
      entityType,
      states: [
        'DRAFT',
  ...
  { permission: 'PERM-FIND-CREATE', action: 'CREATE', entityType: 'FINDING', states: ['DRAFT'] },
  {
    permission: 'PERM-FIND-EDIT',
    action: 'EDIT',
    entityType: 'FINDING',
    states: ['DRAFT', 'OPEN'],
  },
  {
    permission: 'PERM-FIND-REVIEW',
  ...
  {
    permission: 'PERM-FIND-CLOSE',
    action: 'CLOSE',
    entityType: 'FINDING',
    states: ['UNDER_REVIEW'],
  },
  {
    permission: 'PERM-FIND-VOID',
    action: 'VOID',
    entityType: 'FINDING',
    states: ['DRAFT', 'OPEN', 'UNDER_REVIEW'],
  },
  { permission: 'PERM-NCR-CREATE', action: 'CREATE', entityType: 'NCR', states: ['DRAFT'] },
  {
    permission: 'PERM-NCR-EDIT',
  ...
  },
  {
    ...
    action: 'START_RCA',
    entityType: 'NCR',
    states: ['UNDER_INVESTIGATION'],
  },
  {
    permission: 'PERM-NCR-EDIT',
    action: 'MOVE_TO_CAPA',
    entityType: 'NCR',
    states: ['RCA_IN_PROGRESS'],
  },
  {
    permission: 'PERM-NCR-EDIT',
    action: 'READY_FOR_CLOSURE',
    entityType: 'NCR',
    states: ['CAPA_IN_PROGRESS'],
  },
  {
  ...
  { permission: 'PERM-CAPA-CREATE', action: 'CREATE', entityType: 'CAPA', states: ['DRAFT'] },
  { permission: 'PERM-CAPA-EDIT', action: 'START', entityType: 'CAPA', states: ['OPEN'] },
  {
  ...
  { permission: 'PERM-TASK-CREATE', action: 'ACTIVATE', entityType: 'TASK', states: ['DRAFT'] },
  {
    ...
    action: 'ASSIGN',
    entityType: 'TASK',
    states: ['DRAFT', 'OPEN', 'IN_PROGRESS', 'ON_HOLD'],
  },
  ...
  ...(['RECEIVING_ITEM'].flatMap((entityType) => [
    {
    ...
    { permission: 'PERM-QUAR-CREATE', action: 'CREATE', entityType, states: ['PENDING'] },
    {
    ...
    {
      permission: 'PERM-QUAR-START-INSPECTION',
      action: 'START_INSPECTION',
      entityType,
      states: ['READY_FOR_INSPECTION'],
    },
    {
      permission: 'PERM-QUAR-HOLD',
      action: 'HOLD',
      entityType,
      states: [
        'PENDING',
  ...
  },
  {
    ...
    entityType: 'RECEIVING_ITEM',
    states: ['UNDER_INSPECTION'],
  },
  {
    permission: 'PERM-QUAR-EDIT',
    action: 'MOVE_TO_RELEASE_PENDING',
    entityType: 'RECEIVING_ITEM',
    states: ['INSPECTION_COMPLETE'],
  },
  {
  ...
  {
    permission: 'PERM-DASH-MANAGEMENT',
    action: 'VIEW',
  ...
  { permission: 'PERM-DASH-ADMIN', action: 'VIEW', entityType: 'DASHBOARD', states: ['ACTIVE'] },
  {
    permission: 'PERM-QUAR-VIEW',
    action: 'VIEW',
    entityType: 'QUARANTINE_DASHBOARD',
    states: ['ACTIVE'],
  },
  {
  ...
  {
    permission: 'PERM-RPT-EXPORT-XLSX',
    action: 'EXPORT',
    entityType: 'REPORT',
    states: ['ACTIVE'],
  },
  {
    ...
    states: ['DRAFT', 'ACTIVE', 'OUT_OF_SERVICE', 'UNDER_MAINTENANCE', 'DECOMMISSIONED'],
  },
  ...
  {
    permission: 'PERM-EQP-CHANGE-STATUS',
    action: 'ACTIVATE',
    entityType: 'EQUIPMENT',
    states: ['DRAFT'],
  },
  ...
  },
  {
    ...
    entityType: 'EQUIPMENT',
    states: ['ACTIVE', 'OUT_OF_SERVICE'],
  },
  {
    permission: 'PERM-EQP-CHANGE-STATUS',
    action: 'RETURN_TO_SERVICE',
    entityType: 'EQUIPMENT',
    states: ['UNDER_MAINTENANCE', 'OUT_OF_SERVICE'],
  },
  {
    permission: 'PERM-EQP-DECOMMISSION',
    action: 'DECOMMISSION',
    entityType: 'EQUIPMENT',
    states: ['ACTIVE', 'OUT_OF_SERVICE', 'UNDER_MAINTENANCE'],
  },
  {
    permission: 'PERM-CAL-VIEW',
    action: 'VIEW',
    entityType: 'CALIBRATION_RECORD',
    states: ['DRAFT', 'SUBMITTED', 'APPROVED', 'CURRENT', 'DUE', 'OVERDUE', 'SUPERSEDED', 'VOID'],
  },
  {
  ...
  {
    permission: 'PERM-CAL-EDIT-DRAFT',
    action: 'EDIT',
    entityType: 'CALIBRATION_RECORD',
    states: ['DRAFT'],
  },
  {
    permission: 'PERM-CAL-SUBMIT',
    action: 'SUBMIT',
    entityType: 'CALIBRATION_RECORD',
    states: ['DRAFT'],
  },
  {
    permission: 'PERM-CAL-REVIEW',
    action: 'REVIEW',
    entityType: 'CALIBRATION_RECORD',
    states: ['SUBMITTED'],
  },
  {
    permission: 'PERM-CAL-APPROVE',
    action: 'APPROVE',
    entityType: 'CALIBRATION_RECORD',
    states: ['SUBMITTED'],
  },
  {
    permission: 'PERM-CAL-VOID',
    action: 'VOID',
    entityType: 'CALIBRATION_RECORD',
    states: ['DRAFT', 'SUBMITTED', 'APPROVED', 'CURRENT', 'DUE', 'OVERDUE'],
  },
  {
    permission: 'PERM-MNT-VIEW',
    action: 'VIEW',
    entityType: 'MAINTENANCE_RECORD',
    states: ['DRAFT', 'PLANNED', 'IN_PROGRESS', 'COMPLETED', 'CANCELLED', 'VOID'],
  },
  {
  ...
  {
    permission: 'PERM-DOC-EDIT-DRAFT',
    action: 'EDIT',
    entityType: 'DOCUMENT_VERSION',
    states: ['DRAFT'],
  },
  {
    permission: 'PERM-DOC-SUBMIT',
    action: 'SUBMIT',
    entityType: 'DOCUMENT_VERSION',
    states: ['DRAFT'],
  },
  ...
  {
    permission: 'PERM-DOC-REVISE',
    action: 'REVISE',
    entityType: 'DOCUMENT_IDENTITY',
    states: ['APPROVED', 'EFFECTIVE', 'SUPERSEDED'],
  },
  {
    permission: 'PERM-DOC-SUPERSEDE',
    action: 'SUPERSEDE',
    entityType: 'DOCUMENT_VERSION',
    states: ['EFFECTIVE', 'APPROVED'],
  },
  {
  ...
  {
    permission: 'PERM-CHG-EDIT-DRAFT',
    action: 'RESUME',
    entityType: 'CHANGE_REQUEST',
    states: ['RETURNED'],
  },
  {
    permission: 'PERM-CHG-SUBMIT',
    action: 'SUBMIT',
    entityType: 'CHANGE_REQUEST',
    states: ['DRAFT'],
  },
  {
    permission: 'PERM-CHG-REVIEW',
    action: 'REVIEW',
    entityType: 'CHANGE_REQUEST',
    states: ['SUBMITTED'],
  },
  {
    permission: 'PERM-CHG-RETURN',
    action: 'RETURN',
    entityType: 'CHANGE_REQUEST',
    states: ['UNDER_REVIEW'],
  },
  {
    permission: 'PERM-CHG-APPROVE',
    action: 'APPROVE',
    entityType: 'CHANGE_REQUEST',
    states: ['UNDER_REVIEW'],
  },
  {
    permission: 'PERM-CHG-REJECT',
    action: 'REJECT',
    entityType: 'CHANGE_REQUEST',
    states: ['UNDER_REVIEW'],
  },
  {
    permission: 'PERM-CHG-CANCEL',
    action: 'CANCEL',
    entityType: 'CHANGE_REQUEST',
    states: ['DRAFT', 'RETURNED'],
  },
  ...
  {
    permission: 'PERM-BKP-RESTORE-DRILL',
    action: 'REQUEST_RESTORE',
    entityType: 'BACKUP_RESTORE',
    states: ['CREATED', 'VERIFIED'],
  },
  {
    permission: 'PERM-BKP-RESTORE-PRODUCTION',
    action: 'REQUEST_RESTORE',
    entityType: 'BACKUP_RESTORE',
    states: ['CREATED', 'VERIFIED'],
  },
  ...
  ).map((policy): AuthorizationPolicy => ({
    ...policy,
