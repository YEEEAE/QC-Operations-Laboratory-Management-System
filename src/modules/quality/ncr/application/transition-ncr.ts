...
import { transitionNcr, type NcrAction } from '../domain/ncr.js';
...
const p: Record<NcrAction, PermissionCode> = {
  OPEN: 'PERM-NCR-SUBMIT',
  START_INVESTIGATION: 'PERM-NCR-EDIT',
  START_RCA: 'PERM-NCR-EDIT',
  MOVE_TO_CAPA: 'PERM-NCR-EDIT',
  READY_FOR_CLOSURE: 'PERM-NCR-REVIEW',
  CLOSE: 'PERM-NCR-CLOSE',
  VOID: 'PERM-NCR-VOID',
};
export class TransitionNcrUseCase {
  constructor(
    private repo: NcrRepository,
    ...
    authorize(
      {
        ...
        action: i.action,
        entity: { type: 'NCR', id: n.id, state: n.state, ownerId: n.ownerId ?? n.createdBy },
        scope: { ownerId: n.ownerId ?? n.createdBy },
