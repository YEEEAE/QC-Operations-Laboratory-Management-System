...
const permission: Record<
  ...
  | 'PERM-TASK-REOPEN'
> = {
  ACTIVATE: 'PERM-TASK-CREATE',
  START: 'PERM-TASK-EDIT',
  HOLD: 'PERM-TASK-BLOCK',
  RESUME: 'PERM-TASK-EDIT',
  COMPLETE: 'PERM-TASK-COMPLETE',
  CANCEL: 'PERM-TASK-EDIT',
  REOPEN: 'PERM-TASK-REOPEN',
};
const actionName: Record<TaskAction, string> = {
  ACTIVATE: 'ACTIVATE',
  START: 'START',
  HOLD: 'HOLD',
  RESUME: 'RESUME',
...
export class TransitionTaskUseCase {
  ...
  async execute(input: {
    ...
    authorize(
      {
        actor: input.actor,
        permission: permission[input.action],
