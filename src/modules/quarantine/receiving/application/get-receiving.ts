...
export class GetReceivingUseCase {
  constructor(private repo: ReceivingRepository) {}
  async execute(i: { actor: ActorContext; id: string }) {
    ...
    authorize(
      {
        ...
        action: 'VIEW',
        entity: { type: 'RECEIVING_ITEM', id: x.id, state: x.workflowState, ownerId: x.createdBy },
        scope: { ownerId: x.createdBy },
