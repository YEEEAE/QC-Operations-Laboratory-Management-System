...
export type ReceivingAction = 'MARK_READY'|'START_INSPECTION'|'COMPLETE_INSPECTION'|'MOVE_TO_RELEASE_PENDING'|'RELEASE'|'HOLD'|'REMOVE_HOLD'|'MARK_EXPIRED'|'CANCEL';
const transitions: Record<ReceivingWorkflowState, Partial<Record<ReceivingAction, ReceivingWorkflowState>>> = { PENDING:{MARK_READY:'READY_FOR_INSPECTION',HOLD:'HOLD',MARK_EXPIRED:'EXPIRED',CANCEL:'CANCELLED'}, READY_FOR_INSPECTION:{START_INSPECTION:'UNDER_INSPECTION',HOLD:'HOLD',MARK_EXPIRED:'EXPIRED'}, UNDER_INSPECTION:{COMPLETE_INSPECTION:'INSPECTION_COMPLETE',HOLD:'HOLD'}, INSPECTION_COMPLETE:{MOVE_TO_RELEASE_PENDING:'RELEASE_PENDING',HOLD:'HOLD'}, RELEASE_PENDING:{RELEASE:'RELEASED',HOLD:'HOLD'}, RELEASED:{}, HOLD:{}, EXPIRED:{}, CANCELLED:{} };
